<?php
//echo "når vi her til?<br>";
$servername = "sql.itcn.dk:3306";
$username = "maik2274.EADANIA";
$password = "H6U63Nsk4m"; //se din adgangskode på selfservice.itcn.dk
$database = "maik22744.EADANIA"; //skal passe til det website# du har valgt på serveren
